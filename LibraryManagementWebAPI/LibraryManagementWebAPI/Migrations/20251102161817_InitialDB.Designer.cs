...
namespace LibraryManagementWebAPI.Migrations
{
    ...
    [Migration("20251102161817_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.Book", b =>
                {
                    b.HasOne("LibraryManagementWebAPI.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryManagementWebAPI.Entities.Order", b =>
                {
                    b.HasOne("LibraryManagementWebAPI.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementWebAPI.Entities.User", "User")
                        .WithMany()
